...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="<?php echo BASE; ?>/files/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
		...
		<script type='text/javascript' src='<?php echo BASE; ?>/files/js/bootstrap.min.js'></script>
